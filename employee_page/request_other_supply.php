...
if (empty($item_name) || empty($quantity) || empty($department)) {
...
if ($stmt->execute()) {
    echo "<script>alert('Supply request submitted successfully!'); window.location.href='employee_dashboard.php#request';</script>";
} else {
